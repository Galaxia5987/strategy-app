...
class GalaxiaMatchesViewModal(val teamDao: teamDao) : ViewModel() {
    ...
    private val observationJobs = mutableMapOf<GalaxiaAlliancePosition, Job>()

    fun loadTeamData(teamId: Int, alliancePosition: GalaxiaAlliancePosition) {
        if (teamId == 5987) {
    ...
    private fun updateAlliancePosition(position: GalaxiaAlliancePosition, summary: quickGameStats?) {
        when (position) {
            GalaxiaAlliancePosition.BLUE_1 -> _blueTeam1.postValue(summary)
            GalaxiaAlliancePosition.BLUE_2 -> _blueTeam2.postValue(summary)
            GalaxiaAlliancePosition.BLUE_3 -> _blueTeam3.postValue(summary)
            GalaxiaAlliancePosition.RED_1 -> _redTeam1.postValue(summary)
            GalaxiaAlliancePosition.RED_2 -> _redTeam2.postValue(summary)
            GalaxiaAlliancePosition.RED_3 -> _redTeam3.postValue(summary)
        }
    }
    ...
    fun clearSlot(position: GalaxiaAlliancePosition) {
